...
module.exports = __nccwpck_require__(7348);
...
var utils = __nccwpck_require__(4230);
var settle = __nccwpck_require__(4058);
var buildFullPath = __nccwpck_require__(1934);
var buildURL = __nccwpck_require__(1022);
var http = __nccwpck_require__(3685);
var https = __nccwpck_require__(5687);
var httpFollow = (__nccwpck_require__(1069).http);
var httpsFollow = (__nccwpck_require__(1069).https);
var url = __nccwpck_require__(7310);
var zlib = __nccwpck_require__(9796);
var VERSION = (__nccwpck_require__(2587).version);
var createError = __nccwpck_require__(8403);
var enhanceError = __nccwpck_require__(5468);
var transitionalDefaults = __nccwpck_require__(2426);
var Cancel = __nccwpck_require__(7770);
...
var utils = __nccwpck_require__(4230);
var settle = __nccwpck_require__(4058);
var cookies = __nccwpck_require__(8798);
var buildURL = __nccwpck_require__(1022);
var buildFullPath = __nccwpck_require__(1934);
var parseHeaders = __nccwpck_require__(6995);
var isURLSameOrigin = __nccwpck_require__(8071);
var createError = __nccwpck_require__(8403);
var transitionalDefaults = __nccwpck_require__(2426);
var Cancel = __nccwpck_require__(7770);
...
var utils = __nccwpck_require__(4230);
var bind = __nccwpck_require__(8135);
var Axios = __nccwpck_require__(4781);
var mergeConfig = __nccwpck_require__(9397);
var defaults = __nccwpck_require__(1278);
...
axios.Cancel = __nccwpck_require__(7770);
axios.CancelToken = __nccwpck_require__(294);
axios.isCancel = __nccwpck_require__(2115);
axios.VERSION = (__nccwpck_require__(2587).version);

// Expose all/spread
axios.all = function all(promises) {
  return Promise.all(promises);
};
axios.spread = __nccwpck_require__(6460);

// Expose isAxiosError
axios.isAxiosError = __nccwpck_require__(482);
...
var utils = __nccwpck_require__(4230);
var buildURL = __nccwpck_require__(1022);
var InterceptorManager = __nccwpck_require__(590);
var dispatchRequest = __nccwpck_require__(1046);
var mergeConfig = __nccwpck_require__(9397);
var validator = __nccwpck_require__(5446);
...
var isAbsoluteURL = __nccwpck_require__(7353);
var combineURLs = __nccwpck_require__(6611);
...
var utils = __nccwpck_require__(4230);
var transformData = __nccwpck_require__(3821);
...
var utils = __nccwpck_require__(4230);
var normalizeHeaderName = __nccwpck_require__(5011);
var enhanceError = __nccwpck_require__(5468);
var transitionalDefaults = __nccwpck_require__(2426);
...
function getDefaultAdapter() {
  ...
  if (typeof XMLHttpRequest !== 'undefined') {
    ...
    adapter = __nccwpck_require__(7070);
  } else if (typeof process !== 'undefined' && Object.prototype.toString.call(process) === '[object process]') {
    // For node use HTTP adapter
    adapter = __nccwpck_require__(1552);
  }
  return adapter;
}
...
module.exports = function () {
  if (!debug) {
    try {
      ...
      debug = __nccwpck_require__(9694)("follow-redirects");
    }
    catch (error) { /* */ }
...
var debug = __nccwpck_require__(4639);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Aqua = void 0;
const axios_1 = __importDefault(__nccwpck_require__(9202));
/**
...
class Aqua {
    async login(aquaUrl, username, password) {
        ...
        const response = await axios_1.default.post(`${aquaUrl}/api/token`, data, {
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded',
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(7952);
